...
- If any of `report_numbers.ai_replacement_risk_0_100`, `report_numbers.near_term_ai_risk_0_100`, or `report_numbers.overall_cooked_0_100` is over 80, treat the verdict label as **"Pack it up buddy"** (grade F behavior).
